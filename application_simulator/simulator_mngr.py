...
def init_simulation(n_tasks , independent_tasks, receive_mat, send_mat):
    ...
    for time in times:
        ...
        for i in range(32):
            ...
            Utls.acumulated_traffic('traces_{}/traces_{}_{}.txt'.format(time, time, i), time, i, 30)
            Utls.acumulated_traffic('traces_{}/traces_{}_{}.txt'.format(time, time, i), time, i, 40)
            print('\rTime:{} | {} of 32'.format(time, i + 1), end='\r')
